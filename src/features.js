 ...
 */
 var feature = {
  ...
  /**
    ...
    GetLandingHeight: function(last_move, board) {
     ...
     */
     GetRowTransitions: function(board, num_columns) {
      var transitions = 0;
      var last_bit = 1;
     ...
     * on the same row and vice versa.
     */
     GetColumnTransitions: function(board, num_columns) {
      var transitions = 0;
      var last_bit = 1;
    ...
    GetNumberOfHoles: function(board, num_columns) {
      var holes = 0;
     ...
     */
     GetWellSums: function(board, num_columns) {
      var well_sums = 0;
